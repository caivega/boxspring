...
var View = boxspring.define('boxspring.view.View', {
	...
	statics: {
		...
		/**
		 * Begin the transition monitoring.
		 * @static
		 * @since 0.9
		 */
   ...
   /**
	...
	onPropertyChange: function(target, property, newValue, oldValue, e) {
		...
		if (status === PropertyAnimationTransaction.STATUS_READING ||
			status === PropertyAnimationTransaction.STATUS_RUNNING) {
