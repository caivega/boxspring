...
var View = boxspring.define('boxspring.view.View', {
	...
	animatedPropertyValue: function(property) {
		...
		if (value == null) {
			switch (property) { // TODO Make better, right now it's a speed concern
				...
				case 'transform.translation.x': return this.transform.translation.x
				case 'transform.translation.y': return this.transform.translation.y
				case 'transform.rotation': return this.transform.rotation
				case 'transform.scale.x': return this.transform.scale.x
				case 'transform.scale.y': return this.transform.scale.y
				case 'transform.shear.x': return this.transform.shear.x
				case 'transform.shear.y': return this.transform.shear.y
				case 'transform.origin.x': return this.transform.origin.x
				case 'transform.origin.y': return this.transform.origin.y
			}
		}
		return value
	},
